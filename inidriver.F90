	...
	!jesus edel
	character(LEN=Ini_max_string_len)  nnnn, nnnn1, nnnn2, nnnn3, nnnn4,nnnn5
...
!========================================================
	!jesusedel
    call get_command_argument(5,nnnn3)
	outroot=nnnn3
	if (nnnn3== '')  nnnn3='test'
!========================================================
...
!===============================================================================
       !	jesusedel:Aqui agregamos q_n y a_c para que lea el parametro q_n y a_c desde el archivo
!	params.ini, la segunda entrada es el valor en dado caso que no se lea el 
!	valor desde params.ini
       P%h0     = Ini_Read_Double('hubble')
      
 !      P%q_nn= Ini_Read_Double('q_n', 19.d0) 
!        P%evolucionfilec=trim(Ini_Read_String('evolucionfile'))
!        P%fixqpc= Ini_Read_Double('fixqq',0.d0) 
!       P%N_cc= Ini_Read_Double('N_c', 3.d0) 
      	call get_command_argument(2,nnnn)
	call get_command_argument(3,nnnn1)
	call get_command_argument(4,nnnn2)
	call get_command_argument(6,P%evolucionfilec)
	call get_command_argument(7,nnnn4)
        call get_command_argument(8,P%sigmafilec)
	if (nnnn== '')  nnnn='0'
	if (nnnn1== '')  nnnn1='0'
 	if (nnnn2== '')  nnnn2='0'
	if (P%evolucionfilec== '') P%evolucionfilec='evolve.dat'
	if (nnnn4== '')  nnnn4='1000'
	read (nnnn,*)  P%N_cc
	read (nnnn1,*) P%r_vcc
	read (nnnn2,*) P%fixqpc
	read (nnnn4,*) P%Npcc	
        if ( P%sigmafilec== '') P%sigmafilec='sigma8_z.dat'
!	P%r_vcc= Ini_Read_Double('r_vc',10.d0) 
  !     P%c2hc= Ini_Read_Double('cs2h',0.d0) 
   !    P%c2cc= Ini_Read_Double('cs2c',0.d0) 
    !   P%indpruebac= int((Ini_Read_Double('indprueba', 1.d0)))
       !P%Npcc= Ini_Read_Double('Npc', 1000.d0)
